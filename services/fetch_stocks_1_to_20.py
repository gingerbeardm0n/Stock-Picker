#!/usr/bin/env python3
"""
Fetch all stocks trading between $1 and $20
Creates a list for database backfill and ongoing tracking
(Excludes penny stocks under $1)
"""
...
def save_symbol_list(stocks, filename='stocks_1_to_20.json'):
