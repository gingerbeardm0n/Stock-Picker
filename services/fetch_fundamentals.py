...
Usage:
    python database/fetch_fundamentals.py            # all symbols in stocks_1_to_20.txt
    python database/fetch_fundamentals.py --test 20  # first 20 symbols only (for testing)
    python database/fetch_fundamentals.py --symbol AAPL  # single symbol
"""
